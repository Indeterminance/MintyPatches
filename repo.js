{
	...
	"id": "mintymods",
	"patches": {
		"resource_limiter": "Patch that adds an option for max extends, preventing you from getting any extra lives after you've reached your limit. Currently only supports LoLK.",
